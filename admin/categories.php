                                ...
                                <table id="example" class="display responsive-table datatable-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="edit_categories.php?uid=<?php echo $row['id']; ?>"><i class="small material-icons">edit</i></a>&nbsp;<a href="#"><i class="small material-icons">pageview</i></a>&nbsp;<a href="#"><i class="small material-icons">delete</i></a></td>
                                        </tr>               
                                        <?php } ?>
                                    </tbody>
                                </table>
